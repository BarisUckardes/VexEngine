...
namespace Bite.Core
{
    ...
    public sealed class FreeGameResolver : GraphicsResolver
    {

        public FreeGameResolver()
        {
            m_Renderables = new List<ForwardMeshRenderable>();
            m_Observers = new List<FreeGameObserver>();
        }
        ...
        {
            Vex.Profiling.Profiler.StartProfile();
             ...
             * Set state
             */
            PipelineState state = new PipelineState(new PolygonMode(PolygonFillFace.FrontAndBack, PolygonFillMethod.Fill), new CullingMode(TriangleFrontFace.CCW, CullFace.Back));
            ...
            for (int observerIndex = 0; observerIndex < m_Observers.Count; observerIndex++)
            {
                 ...
                 */
                FreeGameObserver observer = m_Observers[observerIndex];
            ...
            Vex.Profiling.Profiler.EndProfile();
        }

        private List<FreeGameObserver> m_Observers;
