...
namespace Vex.Platform
{
    ...
    public class Window : GameWindow
    {
            ...
            )
        {
            ...
            */
            Framebuffer2D.IntermediateFramebuffer = intermediateFramebufferAsSwapchain == true ? new Framebuffer2D(Size.X, Size.Y) : new Framebuffer2D(1024, 1024, new List<FramebufferAttachmentCreateParams>() {new FramebufferAttachmentCreateParams("Intermediate Color",TextureFormat.Rgb, TextureInternalFormat.Rgb, TextureDataType.UnsignedByte) },true);
        }
